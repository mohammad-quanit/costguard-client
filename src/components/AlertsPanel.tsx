      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {alerts.map((alert) => (
              <div key={alert.id} className="flex items-start space-x-4 p-4 bg-slate-50 rounded-lg">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Button variant="outline" className="h-auto p-4 flex-col items-start">
              ...
              <div className="text-sm text-slate-600">Get notified at 80% of monthly budget</div>
            </Button>
            <Button variant="outline" className="h-auto p-4 flex-col items-start">
              <div className="font-medium mb-1">Daily Spike Alert</div>
              <div className="text-sm text-slate-600">Alert for 50%+ daily cost increases</div>
            </Button>
            <Button variant="outline" className="h-auto p-4 flex-col items-start">
              <div className="font-medium mb-1">Service Anomaly</div>
              <div className="text-sm text-slate-600">Detect unusual service spending patterns</div>
            </Button>
            <Button variant="outline" className="h-auto p-4 flex-col items-start">
              <div className="font-medium mb-1">Weekly Summary</div>
              <div className="text-sm text-slate-600">Weekly cost summary emails</div>
            </Button>
          </div>
        </CardContent>
      </Card>
